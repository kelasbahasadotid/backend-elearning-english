...
exports.getStudentXpDetailHistory = exports.getStudentsXpAnalytics = exports.getLeaderboardChartAnalytics = void 0;
 ...
 */
const getLeaderboardChartAnalytics = async (req, res) => {
    try {
        ...
        const [topStudentsRows] = await db_1.default.query(`
    ...
    `, seasonFilter ? [seasonFilter] : []);
        ...
        const [dailyTrendRows] = await db_1.default.query(`
    ...
    `, [rangeDays]);
        ...
        const [levelDistRows] = await db_1.default.query(`
    ...
    `);
        ...
        const [bucketsRows] = await db_1.default.query(`
      SELECT 
    ...
    `);
        ...
        const [overallRows] = await db_1.default.query(`
      SELECT 
...
exports.getLeaderboardChartAnalytics = getLeaderboardChartAnalytics;
/**
 ...
 */
const getStudentsXpAnalytics = async (req, res) => {
    try {
    ...
    `, queryParams);
        ...
        const [studentRows] = await db_1.default.query(`
...
exports.getStudentsXpAnalytics = getStudentsXpAnalytics;
/**
 ...
 */
const getStudentXpDetailHistory = async (req, res) => {
    try {
    ...
    `, [userId]);
        ...
        const [activityBreakdownRows] = await db_1.default.query(`
      SELECT activity_type,
             CAST(SUM(xp) AS SIGNED) as total_xp,
             COUNT(*) as count
      FROM xp_transactions
    ...
    `, [userId]);
        ...
        const [transactions] = await db_1.default.query(`
    ...
    `, [userId]);
        ...
        const [pastSeasons] = await db_1.default.query(`
...
exports.getStudentXpDetailHistory = getStudentXpDetailHistory;
