...
exports.sendScalevWelcomeEmail = void 0;
const nodemailer_1 = __importDefault(require("nodemailer"));
/**
 * Send automated welcome email to student after Scalev transaction (Light Theme)
 */
const sendScalevWelcomeEmail = async (params) => {
    const { toEmail, customerName, password = 'passwordlms123', packageName, accessDays, expiredAt, loginUrl = process.env.APP_URL || 'https://unenvied-problem-conch.ngrok-free.dev/login', isNewAccount = true } = params;
...
exports.sendScalevWelcomeEmail = sendScalevWelcomeEmail;
