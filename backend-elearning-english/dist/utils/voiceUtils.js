...
exports.CURATED_VOICES = exports.VOICE_ALIAS_MAP = void 0;
...
function resolveVoice(voiceName) {
    ...
    if (exports.VOICE_ALIAS_MAP[clean]) {
        return exports.VOICE_ALIAS_MAP[clean];
    }
    const found = Object.keys(exports.VOICE_ALIAS_MAP).find(k => k.toLowerCase() === clean.toLowerCase());
    if (found)
        return exports.VOICE_ALIAS_MAP[found];
    return clean;
}
